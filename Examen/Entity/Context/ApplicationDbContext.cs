    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Product>()
               .HasOne(p => p.Inventory)              // Un producto tiene un inventario
               .WithMany(i => i.Products)            // Un inventario tiene muchos productos
               .HasForeignKey(p => p.IdInventario)   // Clave foránea en Producto
